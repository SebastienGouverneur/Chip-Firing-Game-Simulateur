...
public class ControlerIteration implements ActionListener {
	...
	ControlerIteration(ViewIteration viewIteration,
		...
		viewIteration.getButtonValidate().addActionListener(
				(ActionListener) this);
		viewIteration.getParallelButton().addActionListener(
				(ActionListener) this);
		viewIteration.getSequentialButton().addActionListener(
				(ActionListener) this);
	}
	...
	private void buttonValidatePerformed() {
		...
		modelIteration
				.setPattern(retrivedPattern, Cfg.getInstance().getGraph());
	}
	...
	private void sequentialButtonPerformed() {
		viewIteration.getInputPattern().setText(
				modelIteration.getSequentialPattern());
	}

	private void parallelButtonPerformed() {
		viewIteration.getInputPattern().setText(
				modelIteration.getParallelPattern());
	}
