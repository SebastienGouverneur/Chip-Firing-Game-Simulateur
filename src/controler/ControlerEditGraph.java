...
public class ControlerEditGraph implements ActionListener {
	...
	ControlerEditGraph(ViewEditGraph viewEditGraph,
			ModelEditGraph modelEditGraph) {
		this.modelEditGraph = modelEditGraph;
		this.viewEditGrap = viewEditGraph;
		modelEditGraph.addObserver(viewEditGraph);

		viewEditGraph.getValidateButton().addActionListener(
				(ActionListener) this);
		viewEditGraph.getInputFormatGraph().addActionListener(
				(ActionListener) this);
	}
